...
|---:|---|---|---|---|---|
| 1 | Building electricity-load forecasting | Daily/weekly cycles and recurring occupancy patterns | Load at 15–60 min horizon | ASHRAE, Pecan Street, or public building-load data | Candidate; not tested |
