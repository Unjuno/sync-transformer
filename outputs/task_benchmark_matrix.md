...
The current repository has canonical ETT evidence, three measured electricity client series, and three measured BDG2 HVAC meters. The remaining rows are a falsifiable experiment roadmap, not claims of performance.
