...
| Road traffic | METR-LA (2 sensors) | measured | measured | Sensor-dependent; spatial effects not evaluated |
| HVAC | BDG2 (3 meters) | measured | measured | Series-dependent; no building-wide claim |
...
The current repository has canonical ETT evidence, three measured electricity client series, two METR-LA sensors, and three BDG2 meters. The remaining rows are a falsifiable experiment roadmap, not claims of performance.
