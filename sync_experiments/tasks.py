...
TASKS = (
    ...
    TaskSpec("traffic", "forecasting", "METR-LA/PEMS-BAY", "traffic", ("mse", "mae", "bootstrap_ci", "abstention_rate"), "benchmarked_two_sensors"),
    TaskSpec("hvac", "forecasting", "Building Data Genome 2", "hvac", ("mse", "mae", "bootstrap_ci", "abstention_rate"), "benchmarked_three_meters"),
    ...
    TaskSpec("robot_manipulation", "trajectory", "RoboMimic/Open X subset", "robomimic", ("ade", "fde", "success_rate", "fallback_rate", "safety_violations"), "adapter_ready_data_acquired"),
